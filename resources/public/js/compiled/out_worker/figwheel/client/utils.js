...
return (new CustomEvent(event_name,(function (){var obj32204 = {"detail":data};
return obj32204;
})()));
} else {
...
var f = (function (){var pred__32211 = cljs.core._EQ_;
var expr__32212 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__32211.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__32212))){
return ((function (pred__32211,expr__32212){
return (function (p1__32205_SHARP_){
return console.warn(p1__32205_SHARP_);
});
;})(pred__32211,expr__32212))
} else {
if(cljs.core.truth_(pred__32211.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__32212))){
return ((function (pred__32211,expr__32212){
return (function (p1__32206_SHARP_){
return console.debug(p1__32206_SHARP_);
});
;})(pred__32211,expr__32212))
} else {
if(cljs.core.truth_(pred__32211.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__32212))){
return ((function (pred__32211,expr__32212){
return (function (p1__32207_SHARP_){
return console.error(p1__32207_SHARP_);
});
;})(pred__32211,expr__32212))
} else {
return ((function (pred__32211,expr__32212){
return (function (p1__32208_SHARP_){
return console.log(p1__32208_SHARP_);
});
;})(pred__32211,expr__32212))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__32215){
...
var opts = map__32216__$1;
var eval_fn = cljs.core.get.call(null,map__32216__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__32218_SHARP_);
});})(new_def))
);
...
return (function (p__32219){
var vec__32220 = p__32219;
var ky = cljs.core.nth.call(null,vec__32220,(0),null);
var v = cljs.core.nth.call(null,vec__32220,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1530950271390
